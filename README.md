...
#### [UserDetailsService]
UserDetails 객체를 반환하는 단 하나의 메소드를 가지고 있음. 일반적으로 이를 구현한 클래스의 내부에 UserRepository를 주입받아 DB와 연결하여 처리. UserDetails 인터페이스는 아래와 같음
```java
...
<!-- <img src="https://velog.velcdn.com/images/gale4739/post/10206d9d-d47b-4b88-b5ec-b639cc7a7eb8/image.png" /> -->